...
$headers2.Add('Content-Type', 'application/zip')
$headers2.Add('X-Target-Workspace', "$APEX_WORKSPACE")
$response2 = Invoke-WebRequest -Method PUT -Headers $headers2 -Infile "f$APP_ID.zip" -Uri "https://$ORDS_HOST$ORDS_CONTEXT/$ORDS_SCHEMA_ALIAS/deploy/app/$APP_ID"
