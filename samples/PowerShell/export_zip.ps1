...
$headers2.Add('Accept', 'application/zip')
Invoke-WebRequest -Method GET -Headers $headers2 -Uri "https://$ORDS_HOST$ORDS_CONTEXT/$ORDS_SCHEMA_ALIAS/backup/app/$APP_ID" -OutFile f$APP_ID.zip
